...
Real-time은 현재 재생 배속을 반영해서 실제로 몇 분이 남았는지 작은 hover box로 보여줍니다.
...
Real-time은 사이트마다 hover하는 위치가 조금 다릅니다.

| 사이트 | hover 위치 | hover box 위치 |
| --- | --- | --- |
...
3. 지원 구조에 적힌 위치에 마우스를 올립니다.
4. `Adjusted time` box에서 현재 배속과 실제 남은 시간을 확인합니다.
